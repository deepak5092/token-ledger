...
export function ChatPanel() {
  ...
  // Bumped whenever the sidebar's list might be stale (a new conversation
  // was just created, or a turn just finished and could have moved this
  // conversation to the top) -- ConversationSidebar re-fetches on change.
  ...
  const onSelectConversation = async (id: string) => {
    if (pending || id === conversationId) return;
